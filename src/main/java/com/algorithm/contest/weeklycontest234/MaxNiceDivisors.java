...
public class MaxNiceDivisors {
    public static void main(String[] args) {
        System.out.println(new MaxNiceDivisors().maxNiceDivisors(5));
        System.out.println(new MaxNiceDivisors().maxNiceDivisors(73));
        System.out.println(maxNiceDivisors(18));
        System.out.println(qmi(3, 2));
    }
    ...
    public static int maxNiceDivisors(int primeFactors) {
        ...
        int p = primeFactors / 3, r = primeFactors % 3;

        if (r == 0) {
            return qmi(3, p);
        } else if (r == 1) {
            return (int) (qmi(3, p - 1) * 4l % MOD);
        } else if (r == 2) {
            return (int) (qmi(3, p) * 2l % MOD);
        }
        return 0;
    }
