...
import com.algorithm.dynamicprogramming.Solution;
...
public class Test2 {
    public static void main(String[] args) {
        ...
        // int[] startTime = {0, 7, 9};
        // int[] endTime = {1, 8, 10};
        // System.out.println(new Test2().maxFreeTime(eventTime, startTime, endTime));
        // // Output: 7
        String p = "*d";
        String[] ws = p.split("\\*");
        ...
        // int eventTime2 = 86;
        // int[] startTime2 = { 22, 82 };
        // int[] endTime2 = { 66, 85 };
        // System.out.println(new Test2().maxFreeTime(eventTime2, startTime2, endTime2)); // Output: 38
